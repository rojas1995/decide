...
class PostProcTestCase(APITestCase):
    ...
    def test_identity(self):
      ...
      def test_simple(self):
        ...
        expected_result = [
            { 'option': 'Partido 3', 'number': 3, 'votes': 45, 'postproc': 23 },
            { 'option': 'Partido 2', 'number': 2, 'votes': 20, 'postproc': 10 },
            { 'option': 'Partido 4', 'number': 4, 'votes': 15, 'postproc': 7 },
            { 'option': 'Partido 1', 'number': 1, 'votes': 10, 'postproc': 5 },
            { 'option': 'Partido 5', 'number': 5, 'votes': 8, 'postproc': 4 },
            { 'option': 'Partido 6', 'number': 6, 'votes': 2, 'postproc': 1 },
        ]
    ...
    def test_simple2(self):
        ...
        expected_result = [
            { 'option': 'Partido 3', 'number': 3, 'votes': 500, 'postproc': 50 },
            { 'option': 'Partido 1', 'number': 1, 'votes': 200, 'postproc': 20 },
            { 'option': 'Partido 4', 'number': 4, 'votes': 100, 'postproc': 10 },
            { 'option': 'Partido 6', 'number': 6, 'votes': 90, 'postproc': 9 },
            { 'option': 'Partido 5', 'number': 5, 'votes': 60, 'postproc': 6 },
    ...
    def test_simple3(self):
        ...
        expected_result = [
            { 'option': 'Partido 1', 'number': 1, 'votes': 5000, 'postproc': 100 },
            { 'option': 'Partido 2', 'number': 2, 'votes': 2000, 'postproc': 40 },
            { 'option': 'Partido 3', 'number': 3, 'votes': 1000, 'postproc': 20 },
            { 'option': 'Partido 5', 'number': 5, 'votes': 800, 'postproc': 16 },
            { 'option': 'Partido 6', 'number': 6, 'votes': 700, 'postproc': 14 },
            { 'option': 'Partido 4', 'number': 4, 'votes': 500, 'postproc': 10 },
        ]
    ...
    def test_simple5(self):
        ...
        expected_result = [
            ...
            { 'option': 'Partido 1', 'number': 1, 'votes': 10, 'postproc': 2 },
            { 'option': 'Partido 5', 'number': 5, 'votes': 3, 'postproc': 0 },
            { 'option': 'Partido 6', 'number': 6, 'votes': 2, 'postproc': 0 },
        ]
